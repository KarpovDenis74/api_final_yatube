    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='Slug сообщества')),
        ...
        migrations.AddField(
            model_name='post',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='post_group', to='api.group'),
        ),
        migrations.CreateModel(
            name='Follow',
            fields=[
